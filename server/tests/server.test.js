...
const {todos, users, populateTodos, populateUsers, user1ID} = require('./seed/seed')
...
describe('POST /users/login', () => {
  it('should login user login and return auth token', (done) => {
    request(app)
      .post('/users/login')
  ...
  it('should reject incorrect login', (done) => {
    request(app)
      .post('/users/login')
      .send({email: users[1].email, password: 'asdbfd'})
      .expect(400)
      .expect((res) => {
...
describe('DELETE /users/me/token', () => {
  it('should remove an auth token on log out', (done) => {
    request(app)
